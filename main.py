...
def index():
    ...
    if request.form['plainText'] != '':
        ...
        print(plainText)
        return render_template('index.html', secretKey = secretKey.decode('utf-8'), plainText = plainText, encrypted = encrypted.hex(), time = timeit.default_timer() - start)
    ...
    if request.form['cipherText'] != '':
        ...
        return render_template('index.html', secretKey = secretKey.decode('utf-8'), cipherText = cipherText, decrypted = decrypted.decode('utf-8'), time = timeit.default_timer() - start)
    return render_template('index.html')
